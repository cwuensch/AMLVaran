...
function createGUI()
{
  ...
  GUIHtml += '</div>';  // filters
  GUIHtml += '<div class="filter-buttons"><button type="button" id="btnReset" class="btn btn-default" onClick="resetGUI()">Reset</button><button type="button" id="btnCalc" class="btn btn-default" onClick="applyFilters2()">Calculate scores</button></div></form>';
